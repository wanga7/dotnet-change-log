...
public class WhenGettingTitleForDirectChangelog
{
    private const string ExpectedTitle = "1.0.0 (2020-10-14)...1.1.0 (2020-10-15)";
    ...
    public void Context()
    {
        _generatedTitle = Changelog.GetTitleForDirectChangelog();
    }

    [Test]
    public void ShouldIncludeBothVersionTagsAndDate()
    {
